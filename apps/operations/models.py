...
class UserFavorite(models.Model):
    """用户收藏，包括收藏课程、收藏机构、收藏讲师"""
    user = models.ForeignKey(UserProfile, verbose_name=u'用户')
    fav_id = models.IntegerField(default=0, verbose_name=u'数据id')  # 1代表课程，2代表机构，3代表讲师
...
class UserMessage(models.Model):
    """用户消息"""
    user = models.IntegerField(default=0, verbose_name=u'接收用户')  # 默认为0，代表该消息发给所有用户
